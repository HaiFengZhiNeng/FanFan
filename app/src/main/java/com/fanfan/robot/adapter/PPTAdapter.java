...
public class PPTAdapter extends SimpleAdapter<File> {

    private Handler mHandler;

    private List<Boolean> isClicks;

    public PPTAdapter(Context context, List<File> datas) {
    ...
    @Override
    protected void convert(BaseRecyclerViewHolder viewHolder, File item, int pos) {
